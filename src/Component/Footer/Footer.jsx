                ...
                <div className="container">
                    <div className="footer sm:footer-horizontal text-base-content sec-gap max-md:gap-3">
                        ...
                        <nav data-aos="fade-up" data-aos-delay="300">
                            <h4 className="footer-title text-[var(--orange)] opacity-100">Company</h4>
                        ...
                        <nav data-aos="fade-up" data-aos-delay="400">
                            <h4 className="footer-title text-[var(--orange)] opacity-100">Legal</h4>
                    ...
                    <div className="footer sm:footer-horizontal text-base-content py-4 border-[var(--orange)] border-t flex justify-between items-center flex-wrap max-md:gap-2" data-aos="fade-up" data-aos-delay="500">
                        <div>
