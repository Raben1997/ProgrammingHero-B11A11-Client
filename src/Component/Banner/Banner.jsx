                ...
                <div className='container sec-gap'>
                    <div className='max-w-full w-[550px]'>
                        <div>
                            ...
                            <form className='border rounded-4xl border-[var(--orange)] shadow flex mt-4 md:mt-5 lg:mt-6 !max-w-full'>
                                <input type="email" placeholder='youmail@email.com' name='email' className='outline-0 py-2 sm:py-4 px-3 sm:px-6 text-[var(--blue)] placeholder:text-[var(--orange)] text-sm sm:text-base leading-relaxed w-[50%] sm:w-[70%] ' />
                                <button type='button' className='py-2 sm:py-4 px-3 sm:px-6 bg-[var(--orange)] rounded-4xl font-bold text-[var(--dark_light)] cursor-pointer hover:bg-[var(--blue)] text-sm sm:text-base leading-relaxed w-[50%] sm:w-[30%]'>Subscribe Us</button>
                            </form>
                        </div>
                    </div>
                </div>
